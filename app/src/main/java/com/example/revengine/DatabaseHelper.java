...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Cursor getCarsUnder200HP() {
        SQLiteDatabase db = this.getReadableDatabase();
        String[] columns = {COL_ID, COL_PRODUCT_NAME, COL_PRODUCT_PRICE, COL_PRODUCT_QUANTITY, COL_PRODUCT_IMAGE_URI};
        String selection = COL_PRODUCT_QUANTITY + " >= ?";
        String[] selectionArgs = {"200"};
        return db.query(TABLE_PRODUCTS, columns, selection, selectionArgs, null, null, null);
    }

    public Cursor getMotorbikes200HPAndAbove() {
        SQLiteDatabase db = this.getReadableDatabase();
        String[] columns = {COL_ID, COL_PRODUCT_NAME, COL_PRODUCT_PRICE, COL_PRODUCT_QUANTITY, COL_PRODUCT_IMAGE_URI};
        String selection = COL_PRODUCT_QUANTITY + " < ?";
        String[] selectionArgs = {"200"};
